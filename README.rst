...
:Version: 0.0.0
:Web: https://github.com/luismayta/zsh-deno
:Download: https://github.com/luismayta/zsh-deno
:Source: https://github.com/luismayta/zsh-deno
:Keywords: zsh-deno
...
2. Clone the plugin
    ``bash   git clone https://github.com/luismayta/zsh-deno``\ bash
3. Edit your ``.zshrc`` and add
    ``plugins=( ... zsh-deno )`` to your list of
    plugins
...
1. Add :
    ...
    .. code-block:: bash
        ...
        antibody bundle luismayta/zsh-deno

    to your ``.zshrc`` where you're adding your other plugins.
2. Either open a new terminal to force zsh to load the new plugin, or
    run ``antibody bundle luismayta/zsh-deno`` in a
    running zsh session.
3. Enjoy!
...
.. |Build Status| image:: https://travis-ci.org/luismayta/zsh-deno.svg
    :target: https://travis-ci.org/luismayta/zsh-deno
.. |GitHub issues| image:: https://img.shields.io/github/issues/luismayta/zsh-deno.svg
    :target: https://github.com/luismayta/zsh-deno/issues
...
.. |beacon| image:: https://ga-beacon.appspot.com/UA-65019326-1/github.com/luismayta/zsh-deno/readme
    :target: https://github.com/luismayta/zsh-deno
